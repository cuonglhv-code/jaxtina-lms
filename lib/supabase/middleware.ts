 ...
 * session token stays alive. Must be called from the root proxy.ts.
 *
 ...
 *
 * If Supabase is unreachable or env vars are missing, fails fast with
 * NextResponse.next() rather than hanging the middleware.
 */
